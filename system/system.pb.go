...
var file_system_proto_rawDesc = []byte{
	...
	,
}
...
var file_system_proto_goTypes = []interface{}{
	(*SystemRequest)(nil), // 0: system.SystemRequest
	(*System)(nil),        // 1: system.System
	(*Systems)(nil),       // 2: system.Systems
	(*empty.Empty)(nil),   // 3: google.protobuf.Empty
}
var file_system_proto_depIdxs = []int32{
	1, // 0: system.Systems.systems:type_name -> system.System
	0, // 1: system.SystemService.GetSystem:input_type -> system.SystemRequest
	3, // 2: system.SystemService.GetAllSystems:input_type -> google.protobuf.Empty
	1, // 3: system.SystemService.GetSystem:output_type -> system.System
	2, // 4: system.SystemService.GetAllSystems:output_type -> system.Systems
...
func (c *systemServiceClient) GetSystem(ctx context.Context, in *SystemRequest, opts ...grpc.CallOption) (*System, error) {
	out := new(System)
	err := c.cc.Invoke(ctx, "/system.SystemService/GetSystem", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *systemServiceClient) GetAllSystems(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*Systems, error) {
	out := new(Systems)
	err := c.cc.Invoke(ctx, "/system.SystemService/GetAllSystems", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SystemService_GetSystem_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/system.SystemService/GetSystem",
	}
...
func _SystemService_GetAllSystems_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/system.SystemService/GetAllSystems",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
